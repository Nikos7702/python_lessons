"""
Ресторан надає можливість зробити онлайн замовлення страв. Розмір знижки по замовленню залежить від карти лояльності,
 яку має клієнт: Regular, Silver або Gold.
...
class RegularDiscount(Discount):
    def __init__(self):
        super().__init__(discount_rate=0.95)  # 5% Regular



class SilverDiscount(Discount):
    def __init__(self):
        super().__init__(discount_rate=0.9)  # 10% Silver


class GoldDiscount(Discount):
    def __init__(self):
        super().__init__(discount_rate=0.8)  # 20%  Gold
...
silver_client = Client("Emily", SilverDiscount())
gold_client = Client("James", GoldDiscount())
